...
void main() {
  ...
  testWidgets('Bottom nav: Bets and MyTickets for logged-in user', (tester) async {
          ...
          routes: [
            ...
            GoRoute(
              ...
              pageBuilder: (context, state) => const NoTransitionPage(
                child: Scaffold(body: Center(child: Text('bets_screen_marker'))),
              ),
            ),
            GoRoute(
              path: '/my-tickets',
    ...
    // Navigate to Bets
    await tester.tap(find.byKey(const Key('nav_bets')));
    await tester.pumpAndSettle();
    // Arrived to bets route (dummy content in test router)
